...
/** \mainpage RoboComp::navigationComponent
 *
 * \section intro_sec Introduction
 *
 * The navigationComponent component...
 *
 ...
 *
 * Just: "${PATH_TO_BINARY}/navigationComponent --Ice.Config=${PATH_TO_CONFIG_FILE}"
 *
...
void ::navigationComponent::initialize()
{
...
int ::navigationComponent::run(int argc, char* argv[])
{
#ifdef USE_QTGUI

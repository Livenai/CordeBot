...
//                qDebug() << "Neigh "<< QPointF(n.first.x,n.first.z);
        ...
        {
            const int &I = dim.TILE_SIZE;
            static const std::vector<int> xincs = {-3*I,-2*I, -I, 0, I, 2*I,3*I,3*I,3*I,3*I,3*I,3*I,3*I, 2*I, I, 0, -I,-2*I,-3*I,-3*I,-3*I,-3*I,-3*I,-3*I };
            static const std::vector<int> zincs = {3*I,3*I,3*I,3*I,3*I,3*I,3*I,2*I,I,0,-I,-2*I,-3*I,-3*I,-3*I,-3*I,-3*I,-3*I,-3*I,-2*I,-I,0,I,2*I};

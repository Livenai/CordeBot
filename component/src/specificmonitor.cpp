...
void SpecificMonitor::readConfig(RoboCompCommonBehavior::ParameterList &params )
{
	...
	// ESTABLECEMOS LA CONFIGURACION DE navigation.h
	...
	aux.editable = false;
	configGetString("NavigationAgent", "RobotName", aux.value,"dalomismoloquepongasaqui");
	...
	aux.editable = false;
	configGetString( "NavigationAgent","OuterRegionLeft", aux.value,"-2500");
	params["OuterRegionLeft"] = aux;

	aux.editable = false;
	configGetString( "NavigationAgent","OuterRegionRight", aux.value,"2500");
	params["OuterRegionRight"] = aux;

	aux.editable = false;
	configGetString( "NavigationAgent","OuterRegionBottom", aux.value,"-7500");
	params["OuterRegionBottom"] = aux;

	aux.editable = false;
	configGetString( "NavigationAgent","OuterRegionTop", aux.value,"7500");

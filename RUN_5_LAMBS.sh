...
if [ $# -eq 1 ]
  then
    taskset -c 0 /home/robocomp/robocomp/components/CordeBot/navigationComponent/bin/navigationComponent --Ice.Config=/home/robocomp/robocomp/components/CordeBot/navigationComponent/etc/config0 &
    sleep $1s
